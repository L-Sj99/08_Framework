...
@Transactional // 내부 메서드 수행 후 트랜잭션 처리 수행 : 예외 발생 시 rollback, 아님 commit
...
public class TodoListServiceImpl implements TodoListService{
	...
	// 할 일 상세조회
	@Override
	public Todo listCheck(int listNo) {
		return mapper.listCheck(listNo);
	}
	
	// 완료 여부 변경
	@Override
	public int todoComplete(int listNo) {
		return mapper.todoComplete(listNo);
	}
	...
	// 할 일 삭제
	@Override
	public int todoDelete(int listNo) {
		return mapper.todoDelete(listNo);
	}
	
	@Override
	public String searchTitle(int listNo) {
		return mapper.searchTitle(listNo);
	}

...
public class ErrorControllerAdvice {
	...
	@ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR) // 500번 error
	public String dataAccessExceptionHandle(DataAccessException e, Model model) {
